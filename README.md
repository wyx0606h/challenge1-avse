...
|-------|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| **overall** | 4284 | −4.0691 | 1.1470 | 0.3882 | 0.9357 | 2.2586 | 1.9667 | 2.7701 | 1.5993 | 0.7726 | 0.3821 |
| track1 / mix | 2484 | — | — | — | 0.9294 | 2.2906 | 2.0419 | 2.8697 | 1.6723 | 0.7345 | 0.4039 |
| track1 / remix | 1800 | −4.0691 | 1.1470 | 0.3882 | 0.9444 | 2.2145 | 1.8629 | 2.6326 | 1.4986 | 0.8252 | 0.3521 |

**Track 2**

| scope | n | SI-SDR | PESQ | STOI | UTMOS | DNSMOS p808 | DNSMOS sig | DNSMOS bak | DNSMOS ovr | CER | spk_sim |
|-------|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| **overall** | 5250 | −2.8507 | 1.2556 | 0.4697 | 1.1777 | 2.3706 | 1.7458 | 1.7055 | 1.3960 | 0.8707 | 0.3704 |
| track2 / mix | 3054 | — | — | — | 1.1875 | 2.4027 | 1.8200 | 1.7783 | 1.4492 | 0.8657 | 0.3844 |
| track2 / remix | 2196 | −2.8507 | 1.2556 | 0.4697 | 1.1641 | 2.3259 | 1.6427 | 1.6042 | 1.3220 | 0.8776 | 0.3509 |
...
See
[docs/experiments/track2_dev_official_baseline.md](docs/experiments/track2_dev_official_baseline.md)
for the complete DNSMOS breakdown, commands, environment snapshot, updated
README comparison, and known caveats. The official README table was refreshed
upstream after the local run; the local run remains close on objective metrics,
DNSMOS, and speaker similarity, while CER differs by scene. For subsequent
`exp/*` branches, use this recorded local run as the team's stable comparison
baseline and cite the upstream README values separately when discussing
organizer-published reference scores.
