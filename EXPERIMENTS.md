...
| EXP-008 | Hierarchical visual temporal fusion v1/v2 | Planned | `exp/hierarchical-visual-fusion` | TODO | EXP-006 / `2aeb35a65f15fc0c215abc5c651f4f7579edd5d4` | v1 will aggregate V-TCN layers 1/3/5 at the existing fusion point; v2 will add stage-matched reliability-gated residual injection; no result yet | `docs/experiments/EXP-008-hierarchical-visual-fusion.md` |
