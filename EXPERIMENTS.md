...
| EXP-004 | Safe reliability-gated visual fusion | Planned | `exp/safe-reliability-gate` | TODO | `EXP-002` / `exp/experiment-cross` | No result yet | `docs/experiments/EXP-004-safe-reliability-gated-fusion.md` |
