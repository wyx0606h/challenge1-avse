...
| EXP-009 | Pretrained visual representations v1/v2 | Planned | `exp/pretrained-visual-representations` | `3a9e5b7` | EXP-008 V1 implementation / `3c41486b29bee98aa20c20d5fab54875864b9cd3` | v1 replaces the legacy ResNet with a frozen AV-HuBERT visual frontend; v2 adds local/context visual evidence through an audio-anchored residual gate; implementation and local syntax/config checks passed, server validation pending; `degrade_prob=0.0` is locked for the first comparison | `docs/experiments/EXP-009-pretrained-visual-representations.md` |
