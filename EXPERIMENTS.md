...
| EXP-003 | Native-rate temporal cross-attention | Planned | `exp/cross-attention-v2` | TODO | `baseline/track2-source-v1` | No result yet | `docs/experiments/EXP-003-cross-attention-fusion.md` |
